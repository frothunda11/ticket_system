...
$role_permissions = [
    'admin' => ['main', 'login','dashboard','feedback','users','create_ticket', 'view_tickets'],
    'editor' => ['main', 'login','dashboard', 'feedback','create_ticket', 'view_tickets'],
    'viewer' => ['main', 'login', 'feedback','create_ticket', 'view_tickets'],
];
